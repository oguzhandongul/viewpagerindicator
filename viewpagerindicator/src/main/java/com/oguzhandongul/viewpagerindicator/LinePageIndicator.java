...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        @ColorInt int unselectedColor = a.getColor(R.styleable.LinePageIndicator_unselectedColor, defaultUnselectedColor);
        mPaintUnselected.setColor(unselectedColor);
        @ColorInt int selectedColor = a.getColor(R.styleable.LinePageIndicator_selectedColor, defaultSelectedColor);
